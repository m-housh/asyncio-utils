...
def _aiter(iterator) -> typing.Union[typing.Awaitable, typing.AsyncIterator]:
...
async def transform_factory(iterator: IteratorType, _type: TransformType=None
    ...
    if inspect.iscoroutinefunction(_type):
        return await _type([v async for v in iterator])
    return _type([v async for v in iterator])
